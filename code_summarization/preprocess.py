...
def makeDataGeneral(which, src_path, tgt_path, tree_path, dicts):
    ...
    res = {}
    res['src'], res['tgt'], res['trees'], code_sentences, comment_sentences = makeData(which, src_path, tgt_path, tree_path, dicts['src'], dicts['tgt'])
...
def main():
    ...
    print("Saving data to \"" + opt.save_data + ".train.pt2\"...")
    torch.save(save_data, opt.save_data + ".train.pt2")
