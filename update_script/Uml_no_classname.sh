#!/usr/bin/env bash
cd ../
mkdir -p "./Uml_no_classname"
path="Uml_no_classname"
cd $path
...
modeltype='uml'   # 'ast-att-gru', 'att-gru', 'codenn', 'uml', 'h-deepcom'
...
#dty_s=ASTAttGRU_AttTwoChannelTrans_noclassname "ASTAttGRU_BertAtt ASTAttGRU_AttTwoChannel  ASTAttGRU_AttTwoChannelTrans  ASTAttGRU_UML ASTAttGRU_Gate"
dty_s="ASTAttGRU_AttTwoChannelTrans_noclassname"
# build dataset
