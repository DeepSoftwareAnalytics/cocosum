#!/usr/bin/env bash
cd ../
mkdir -p "./output_CoCoGUM_baseline"
path="output_CoCoGUM_baseline"
cd $path
...
modeltype='uml ast-att-gru att-gru codenn uml h-deepcom'   # 'ast-att-gru', 'att-gru', 'codenn', 'uml', 'h-deepcom'
