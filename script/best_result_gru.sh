#!/usr/bin/env bash
cd ../
mkdir -p "./output_best_result_att_gru"
path="output_best_result_att_gru"
cd $path
...
dataset_path="/mnt/Data/csn/dataset/best_result_att_gru"

batch_size="256"

modeltype='att-gru'   #'ast-att-gru''att-gru' "uml"
