#!/usr/bin/env bash
cd ../
mkdir -p "./output_uml_diff_cvoc"
path="output_uml_diff_cvoc"
cd $path
...
# 1000 5000 10000 15000 20000 25000 35000 40000 45000
dvoc_s="10000"
#cvoc_s="1000 5000 10000 15000 20000 25000 35000 40000 45000"
cvoc_s="30000"
svoc_s="10000"
